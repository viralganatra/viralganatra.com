...
function gatsbyRemarkCodeTitles({ markdownAST }) {
  visit(markdownAST, 'code', (node, index) => {
    ...
    const titleNode = {
      type: 'html',
      value: `<div class="gatsby-code-title">${defaultIcon} <span>${title}</span></div>`,
    };
